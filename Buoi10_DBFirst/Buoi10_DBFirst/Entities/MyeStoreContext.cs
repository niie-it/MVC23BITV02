...
namespace Buoi10_DBFirst.Entities;
...
public partial class MyeStoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ChiTietHd>(entity =>
        {
            ...
            entity.Property(e => e.MaHh).HasColumnName("MaHH");
            entity.Property(e => e.SoLuong).HasDefaultValue(1, "DF_Order_Details_Quantity");
        ...
        modelBuilder.Entity<HangHoa>(entity =>
        {
            ...
            entity.Property(e => e.MaHh).HasColumnName("MaHH");
            entity.Property(e => e.DonGia).HasDefaultValue(0.0, "DF_Products_UnitPrice");
        ...
        modelBuilder.Entity<HoiDap>(entity =>
        {
            ...
            entity.Property(e => e.MaNv)
                .HasMaxLength(50)
                .HasColumnName("MaNV");
            entity.Property(e => e.NgayDua).HasDefaultValueSql("(getdate())", "DF_HoiDap_NgayDua");
            entity.Property(e => e.TraLoi).HasMaxLength(50);
...
public DbSet<Buoi10_DBFirst.Models.HangHoaVM> HangHoaVM { get; set; } = default!;
}
