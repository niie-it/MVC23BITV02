...
namespace Buoi08_EFCoreCodeFirst.Controllers
{
    public class LoaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaLoai,TenLoai,Hinh,MoTa")] Loai loai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaLoai,TenLoai,Hinh,MoTa")] Loai loai)
        {
            if (id != loai.MaLoai)
            {
                return NotFound();
